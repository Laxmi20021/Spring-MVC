    ...
    <div class="form-container">
        ...
        <form action="passport" method="post">
            <div class="form-row">
                ...
                <div>
                    <label>
                        <input type="radio" name="register_at" value="CPV Delhi"> CPV Delhi
                    </label>
                    <label>
                        <input type="radio" name="register_at" value="Passport Office" checked> Passport Office
                    </label>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <select id="passport_office" name="passport_office" required>
            ...
            <div class="form-row">
                ...
                <input type="text" id="given_name" name="given_name" maxlength="45" required>
            </div>
            ...
            <div class="form-row">
                ...
                <div>
                    <label>
                        <input type="radio" name="login_id_choice" value="yes"> Yes
                    </label>
                    <label>
                        <input type="radio" name="login_id_choice" value="no" checked> No
                    </label>
                </div>
            </div>
